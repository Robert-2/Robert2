...
return [
    ...
    => "Must equal {{compareTo}}.",

    "{{name}} must not equal {{compareTo}}"
    => "Must not equal {{compareTo}}.",
    ...
    => "Must be less than {{compareTo}}.",

    "{{name}} must be less than or equal to {{compareTo}}"
    => "Must be less than or equal to {{compareTo}}.",

    "{{name}} must not be less than {{compareTo}}"
    => "Must not be less than {{compareTo}}.",

    "{{name}} must not be less than or equal to {{compareTo}}"
    => "Must not be less than or equal to {{compareTo}}.",
    ...
    => "This field must contain a decimal number.",
    ...
    => "Must have {{mimetype}} MIME type.",

    "{{name}} must not have {{mimetype}} MIME type"
    => "Must not have {{mimetype}} MIME type.",
    ...
    => "Must be a subdivision code of {{countryName}}.",

    "{{name}} must not be a subdivision code of {{countryName}}"
    => "Must not be a subdivision code of {{countryName}}.",
    ...
    => "Must be greater than {{compareTo}}.",

    "{{name}} must be greater than or equal to {{compareTo}}"
    => "Must be greater than or equal to {{compareTo}}.",

    "{{name}} must not be greater than {{compareTo}}"
    => "Must not be greater than {{compareTo}}.",

    "{{name}} must not be greater than or equal to {{compareTo}}"
    => "Must not be greater than or equal to {{compareTo}}.",
    ...
    => "Only one of the following rules must be verified:",

    "Only one of these rules must not pass for {{name}}"
    => "Only one of the following rules must not be verified:",
    ...
    => "Must be a valid telephone number for the specified country.",

    "{{name}} must not be a valid telephone number for country {{countryName}}"
    => "Must not be a valid telephone number for the specified country.",
    ...
    => "Must not contain digits (0-9) and \"{{additionalChars}}\".",
    ...
    => "Must be {{age}} years or less.",

    "{{name}} must not be {{age}} years or less"
    => "Must not be {{age}} years or less.",

    "{{name}} must be {{age}} years or more"
    => "Must be {{age}} years or more.",

    "{{name}} must not be {{age}} years or more"
    => "Must not be {{age}} years or more.",
    ...
    => "Must be valid for {{constraint}}.",

    "{{name}} must not be valid for {{constraint}}"
    => "Must not be valid for {{constraint}}.",
    ...
    => "The start date is too close.",

    "start-date-is-already-past"
    => "The start date is already past.",

    "material-already-in-cart"
    => "This material is already in cart.",

    "unavailable-quantity"
    => "This quantity is unavailable.",

    "event-cannot-be-archived"
    => "An event cannot be archived if its return inventory is not done!",

    "reservation-cannot-be-archived"
    => "A reservation cannot be archived if its return inventory is not done!",

    "reservation-status-cannot-be-changed"
    => "Once assigned, the status of a reservation cannot be changed.",

    "pending-reservation-cannot-be-archived"
    => "A pending reservation cannot be archived!",

    "invalid-value"
    => "This value is invalid.",

    "field-contains-invalid-values"
    => "This field contains invalid values.",
    ...
    => "Please specify outgoing quantity.",

    "missing-returned-quantity"
    => "Please specify the returned quantity.",

    "missing-units-departure-status"
    => "Please specify the departure status of each unit.",

    "missing-units-return-status"
    => "Please specify the return status of each unit.",

    "invalid-unit-return-status"
    => "Some of the units status are not valid.",
    ...
    => "The outgoing quantity cannot be greater than the planned quantity.",
    ...
    => "The number of outgoing units may not exceed the total outgoing quantity.",

    "returned-units-count-exceed-returned-quantity"
    => "The number of units returned may not exceed the total quantity returned.",

    "returned-broken-units-count-exceed-returned-broken-quantity"
    => "The number of units returned broken may not exceed the total quantity returned broken.",
    ...
    "invalid-csv-mapping"
    => "The mapping of the fields to be used with the CSV is invalid.",
    ...
    => "At least one field must be defined for the park location.",

    "park-location-already-exists-for-this-park"
    => "A park location already exists for the park with this values.",

    "location-does-not-exist-in-selected-park"
    => "This location does not exist in the selected park.",
