...
return [
    ...
    => "Ne doit contenir que des chiffres et «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir aucun chiffre ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir aucune lettre (a-z) ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir que des espaces et «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir aucun espace ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Doit être inférieur à {{compareTo}}.",

    "{{name}} must be less than or equal to {{compareTo}}"
    => "Doit être inférieur ou égal à {{compareTo}}.",

    "{{name}} must not be less than {{compareTo}}"
    => "Ne doit pas être inférieur à {{compareTo}}.",

    "{{name}} must not be less than or equal to {{compareTo}}"
    => "Ne doit pas être inférieur ou égal à {{compareTo}}.",

    "{{name}} must be callable"
    => "Doit être appelable.",

    "{{name}} must not be callable"
    => "Ne doit pas être appelable.",
    ...
    => "Ces règles doivent être validée\xc2\xa0:",

    "None of there rules must pass for {{name}}"
    => "Aucune de ces règles ne doit être validée\xc2\xa0:",

    "These rules must not pass for {{name}}"
    => "Ces règles ne doivent pas être validées\xc2\xa0:",
    ...
    => "Ne doit contenir que des voyelles et «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must not contain vowels"
    => "Ne doit contenir aucune voyelle.",

    "{{name}} must not contain vowels or {{additionalChars}}"
    => "Ne doit contenir aucune voyelle ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "La clé {{name}} ne doit pas être présente.",
    ...
    => "N'est pas considéré «\xc2\xa0False\xc2\xa0».",

    "{{name}} is considered as \"False\""
    => "Est considéré «\xc2\xa0False\xc2\xa0».",
    ...
    => "Doit avoir comme type MIME «\xc2\xa0{{mimetype}}\xc2\xa0».",

    "{{name}} must not have {{mimetype}} MIME type"
    => "Ne doit pas avoir comme type MIME «\xc2\xa0{{mimetype}}\xc2\xa0».",
    ...
    => "Ne doit contenir que des caractères graphiques et «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir aucun caractère graphique ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir que des consonnes et «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must not contain consonants"
    => "Ne doit contenir aucune consonne.",

    "{{name}} must not contain consonants or {{additionalChars}}"
    => "Ne doit contenir aucune consonne ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must be a subdivision code of {{countryName}}"
    => "Doit être un secteur valide de {{countryName}}.",

    "{{name}} must not be a subdivision code of {{countryName}}"
    => "Ne doit pas être un secteur valide de {{countryName}}.",
    ...
    => "Doit être supérieur à {{compareTo}}.",

    "{{name}} must be greater than or equal to {{compareTo}}"
    => "Doit être supérieur ou égal à {{compareTo}}.",

    "{{name}} must not be greater than {{compareTo}}"
    => "Ne doit pas être supérieur à {{compareTo}}.",

    "{{name}} must not be greater than or equal to {{compareTo}}"
    => "Ne doit pas être supérieur ou égal à {{compareTo}}.",
    ...
    => "L'une des règles suivantes doit être vérifiée\xc2\xa0:",

    "At least one of these rules must not pass for {{name}}"
    => "L'une des règles suivantes de doit pas être vérifiée\xc2\xa0:",

    "Only one of these rules must pass for {{name}}"
    => "Une seule des règles suivantes doit être vérifiée\xc2\xa0:",

    "Only one of these rules must not pass for {{name}}"
    => "Une seule des règles suivantes de doit pas être vérifiée\xc2\xa0:",
    ...
    => "Doit être inférieur à {{minAge}} ans.",

    "{{name}} must be greater than {{maxAge}} years ago"
    => "Doit être supérieur à {{maxAge}} ans.",
    ...
    => "Ne doit pas être inférieur à {{minAge}} ans.",

    "{{name}} must not be greater than {{maxAge}} years ago"
    => "Ne doit pas être supérieur à {{maxAge}} ans.",
    ...
    => "N'est pas considéré comme «\xc2\xa0Yes\xc2\xa0».",

    "{{name}} is considered as \"Yes\""
    => "Est considéré comme «\xc2\xa0Yes\xc2\xa0».",
    ...
    => "Ce numéro de téléphone est invalide pour le pays spécifié.",
    ...
    => "Ne doit contenir que des caractères de contrôle et «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must not contain control characters"
    => "Ne doit contenir aucun caractère de contrôle.",

    "{{name}} must not contain control characters or {{additionalChars}}"
    => "Ne doit contenir que des caractères de contrôle et «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} is not considered as \"No\""
    => "N'est pas considéré comme «\xc2\xa0No\xc2\xa0».",

    "{{name}} is considered as \"No\""
    => "Est considéré comme «\xc2\xa0No\xc2\xa0».",
    ...
    => "Ne doit contenir que des chiffres (0-9) et «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must not contain digits (0-9)"
    => "Ne doit contenir aucun chiffre (0-9).",

    "{{name}} must not contain digits (0-9) and {{additionalChars}}"
    => "Ne doit contenir aucun chiffre (0-9) et «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "N'est pas considéré comme «\xc2\xa0True\xc2\xa0».",

    "{{name}} is considered as \"True\""
    => "Est considéré comme «\xc2\xa0True\xc2\xa0».",
    ...
    => "Ne doit contenir que des caractères de ponctuation et «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Ne doit contenir aucun caractère de ponctuation ni «\xc2\xa0{{additionalChars}}\xc2\xa0».",
    ...
    => "Doit être encodé en base 64.",

    "{{name}} must not be Base64-encoded"
    => "Ne doit pas être encodé en base 64.",

    "{{name}} must be a number"
    => "Doit être un nombre.",

    "{{name}} must be a number in the base {{base}}"
    => "Doit être un nombre en base {{base}}.",

    "{{name}} must not be a number"
    => "Must not be a number.",

    "{{name}} must not be a number in the base {{base}}"
    => "Ne doit pas être un nombre en base {{base}}.",

    "{{name}} must be a valid UUID"
    => "Cet identifiant unique (UUID) est invalide.",

    "{{name}} must be a valid UUID version {{version}}"
    => "Cet identifiant unique (UUID) est invalide.",

    "{{name}} must not contain duplicates"
    => "Ne doit pas contenir de données dupliquées.",

    "{{name}} must contain duplicates"
    => "Doit contenir des données dupliquées.",

    "{{name}} must be a valid time in the format {{sample}}"
    => "Doit être une heure valide au format «\xc2\xa0{{sample}}\xc2\xa0».",

    "{{name}} must not be a valid time in the format {{sample}}"
    => "Ne doit pas être une heure au format «\xc2\xa0{{sample}}\xc2\xa0».",

    "{{name}} must be subset of {{superset}}"
    => "Doit être un sous-ensemble de {{superset}}.",

    "{{name}} must not be subset of {{superset}}"
    => "Ne doit pas être un sous-ensemble de {{superset}}.",

    "{{input}} must be valid when executed with {{callable}}"
    => "Doit être valide lorsque exécuté avec {{callable}}.",

    "{{input}} must not be valid when executed with {{callable}}"
    => "Ne doit pas être valide lorsque exécuté avec {{callable}}.",

    "{{name}} must contain at least one of the values {{needles}}"
    => "Doit contenir au moins une des valeurs suivantes: {{needles}}.",

    "{{name}} must not contain any of the values {{needles}}"
    => "Ne doit contenir aucune des valeurs suivantes: {{needles}}.",

    "{{name}} must have {{decimals}} decimals"
    => "Doit avoir {{decimals}} décimales.",

    "{{name}} must not have {{decimals}} decimals"
    => "Ne doit pas avoir {{decimals}} décimales.",

    "{{name}} must be equivalent to {{compareTo}}"
    => "Doit être équivalent à {{compareTo}}.",

    "{{name}} must not be equivalent to {{compareTo}}"
    => "Ne doit pas être équivalent à {{compareTo}}.",

    "{{name}} must be a valid IBAN"
    => "Doit être un IBAN valide.",

    "{{name}} must not be a valid IBAN"
    => "Ne doit pas être un IBAN.",

    "{{name}} must be a ISBN"
    => "Doit être un ISBN valide.",

    "{{name}} must not be a ISBN"
    => "Ne doit pas être un ISBN.",

    "{{name}} must be a NIF"
    => "Doit être un numéro fiscal (NIF) valide.",

    "{{name}} must not be a NIF"
    => "Ne doit pas être un numéro fiscal (NIF).",

    "{{name}} must not contain an Emoji"
    => "Ne doit contenir aucun Emoji.",

    "{{name}} must contain an Emoji"
    => "Doit contenir au moins un Emoji.",

    "{{name}} must be null"
    => "Ce champ ne devrait pas être spécifié.",

    "{{name}} must not be null"
    => "Doit être défini.",

    "The value must be nullable"
    => "Doit pouvoir être indéfini.",
    ...
    => "Doit contenir uniquement des caractères imprimables.",

    "{{name}} must contain only printable characters and \"{{additionalChars}}\""
    => "Doit contenir uniquement des caractères imprimables et «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must not contain printable characters"
    => "Ne doit contenir aucun caractères imprimables.",

    "{{name}} must not contain printable characters or \"{{additionalChars}}\""
    => "Ne doit contenir aucun caractères imprimables ou «\xc2\xa0{{additionalChars}}\xc2\xa0».",

    "{{name}} must be valid for {{constraint}}"
    => "Doit être valide pour {{constraint}}.",

    "{{name}} must not be valid for {{constraint}}"
    => "Ne doit pas être valide pour {{constraint}}.",
    ...
    => "Ne doit pas être trié par ordre croissant.",

    "{{name}} must not be sorted in descending order"
    => "Ne doit pas être trié par ordre décroissant.",

    "{{name}} must be a valid Luhn number"
    => "Must be a valid Luhn number.",

    "{{name}} must not be a valid Luhn number"
    => "Must not be a valid Luhn number.",

    "{{name}} must be leap date"
    => "Doit être une date bissextile.",

    "{{name}} must not be leap date"
    => "Ne doit pas être une date bissextile.",

    "{{name}} must be a leap year"
    => "Doit être une année bissextile.",
    ...
    => "La date de début est trop proche.",

    "start-date-is-already-past"
    => "La date de début est déjà passée.",

    "material-already-in-cart"
    => "Ce matériel est déjà dans le panier.",

    "unavailable-quantity"
    => "Cette quantité n'est pas disponible.",

    "event-cannot-be-archived"
    => "Un événement ne peut pas être archivé si son inventaire de retour n'a pas encore été effectué\xc2\xa0!",

    "reservation-cannot-be-archived"
    => "Une réservation ne peut pas être archivée si son inventaire de retour n'a pas encore été effectué\xc2\xa0!",

    "reservation-status-cannot-be-changed"
    => "Une fois assigné, le statut d'une réservation ne peut plus changer.",

    "pending-reservation-cannot-be-archived"
    => "Une réservation en attente ne peut pas être archivée\xc2\xa0!",

    "invalid-value"
    => "La valeur est invalide.",

    "field-contains-invalid-values"
    => "Le champ contient des valeurs invalides.",
    ...
    "missing-outgoing-quantity"
    => "Veuillez spécifier la quantité sortante.",

    "missing-returned-quantity"
    => "Veuillez spécifier la quantité retournée.",

    "missing-units-departure-status"
    => "Veuillez spécifier le statut de départ de chaque unité.",

    "missing-units-return-status"
    => "Veuillez spécifier le statut de retour de chaque unité.",

    "invalid-unit-return-status"
    => "Le statut de certaines unités est invalide.",
    ...
    "outgoing-quantity-cannot-be-greater-than-planned-quantity"
    => "La quantité sortante ne peut pas être supérieure à la quantité prévue.",
    ...
    "outgoing-units-count-exceed-outgoing-quantity"
    => "Le compte des unités sortantes ne peut pas excéder la quantité sortante totale.",

    "returned-units-count-exceed-returned-quantity"
    => "Le compte des unités retournées ne peut pas excéder la quantité retournée totale.",

    "returned-broken-units-count-exceed-returned-broken-quantity"
    => "Le compte des unités retournées cassées ne peut pas excéder la quantité retournée cassée totale.",

    "material-units-cannot-be-broken-and-lost-at-the-same-time"
    => "Les unités ne peuvent pas être «\xc2\xa0en panne\xc2\xa0» et «\xc2\xa0perdues\xc2\xa0» en même temps.",
    ...
    "invalid-csv-mapping"
    => "Le mapping des champs à utiliser avec le CSV est invalide.",
    ...
    "reference-already-in-use-for-material"
    => "Cette référence est déjà utilisée pour ce matériel.",
    ...
    "at-least-one-field-must-be-defined-for-park-location"
    => "Au moins un champ doit être défini pour l'emplacement.",

    "park-location-already-exists-for-this-park"
    => "Un emplacement existe déjà pour le parc avec ces valeurs.",

    "location-does-not-exist-in-selected-park"
    => "Cet emplacement n'existe pas dans le parc sélectionné.",
