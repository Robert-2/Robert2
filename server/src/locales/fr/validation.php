...
return [
    ...
    => "Ne doit contenir que des chiffres et \"{{additionalChars}}\"",
    ...
    => "Doit avoir comme type MIME \"{{mimetype}}\"",

    "{{name}} must not have {{mimetype}} MIME type"
    => "Ne doit pas avoir comme type MIME \"{{mimetype}}\"",
    ...
    => "Une seule des règles suivantes doit être vérifiée",

    "Only one of these rules must not pass for {{name}}"
    => "Une seule des règles suivantes de doit pas être vérifiée",
    ...
    => "Ne doit contenir aucun chiffre (0-9) et \"{{additionalChars}}\"",
    ...
    => "Doit être une heure valide au format \"{{sample}}\"",

    "{{name}} must not be a valid time in the format {{sample}}"
    => "Ne doit pas être une heure au format \"{{sample}}\"",
    ...
    => "Doit contenir uniquement des caractères imprimables et \"{{additionalChars}}\"",
    ...
    => "Ne doit contenir aucun caractères imprimables ou \"{{additionalChars}}\"",
    ...
    => "Une réservation ne peut pas être archivée si son inventaire de retour n'a pas encore été effectué !",
    ...
    => "Une réservation en attente ne peut pas être archivée !",
