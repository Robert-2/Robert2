...
class Filesystem
{
     ...
     *
     * @param string $directory Le dossier dans lequel on doit récupérer les sous-dessiers.
    ...
    /**
     * Transmet les appels aux méthodes non overloadées / déclarées ici au driver bas niveau.
     *
     ...
     *
     * @return mixed Le retour de la méthdoe bas-niveau.
     */
