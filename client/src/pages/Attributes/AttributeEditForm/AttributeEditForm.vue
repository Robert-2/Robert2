<template>
  <div class="AttributeEditForm">
    <div class="AttributeEditForm__name">
      <input
        ref="InputName"
        type="text"
    ...
    <div class="AttributeEditForm__type">
      <select
        ref="InputType"
    ...
    <div class="AttributeEditForm__unit">
      <input
        ref="InputUnit"
        v-if="hasUnit"
        type="text"
    ...
    <div class="AttributeEditForm__max-length">
      <input
        ref="InputMaxLength"
        v-if="hasMaxLength"
        type="number"
