...
export default {
  ...
  'page-event-return': {
    ...
    'confirm-terminate': "This will update all the «\u00a0out of order\u00a0» quantities for the concerned materials, and it will no longer be possible to modify this inventory.",
