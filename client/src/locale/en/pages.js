...
export default {
    ...
    'page-materials': {
        ...
        'help-edit': (
            ...
            If you check the box "Unitary identification", you'll be able to specify units of this material, in the "units" tab of the material's page, after saving this form.\n
    ...
    'page-inventory': {
        ...
        'confirm-terminate-text': [
            "Besides closing the inventory (and making it not editable), this action will have the following consequences:\n",
