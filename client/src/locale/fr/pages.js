...
export default {
    ...
    'page-materials': {
        ...
        'help-edit': (
            ...
            Si vous cochez la case «\u00a0identification unitaire\u00a0», vous aurez la possibilité de spécifier des unités de ce matériel dans l'onglet «\u00a0unités\u00a0» de la page du matériel, après avoir sauvegardé le présent formulaire.\n
    ...
    'page-inventories': {
        ...
        'underway-events-alert-text': [
            ...
            'Voulez-vous vraiment commencer un inventaire dans ces conditions\u00a0?',
        ].join('\n'),
